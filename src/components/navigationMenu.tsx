...
export const NavigationMenu = ()=>{
    ...
    return(
        <section className="fixed  bottom-0  z-50 w-full md:w-[400px] bg-white/90 backdrop-blur-sm  md:flex justify-center md:items-center h-auto  border-t  border-[$border]" dir="rtl">
